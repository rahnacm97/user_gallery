...
import { registerSchema, loginSchema, } from "../shared/validations/authValidation";
...
const authService = new AuthService(userRepository, otpService, userMapper, tokenService, passwordService);
//Controller
